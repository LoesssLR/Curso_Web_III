...
<body class="container">
	...
	<main class="row">
		<?php
			...
			// L&oacute;gico es para que se vea la tilde en la O
			echo "</tr>";
			...
			// la concatenacion se hace con el punto . y no con el +

			// siempre se termina con ;
		?>
		<br>
		<br>
		<h4>Tipos Enteros</h4>
		...
		<?php
			...
			// vector asociativo, como decir una lista o diccionario con clave y valor, de otros lenguajes
		...
		<?php
			...
			// si se define, ya no es necesario el $
